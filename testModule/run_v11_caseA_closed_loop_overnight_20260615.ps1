...
$OutputDir = "testModule\v11_caseA_closed_loop_overnight_20260615"
$CasePrefix = "v11_caseA_closed_loop_overnight_20260615"
...
try {
  & $Python testModule\run_v11_caseA_closed_loop.py `
    --restart-in testModule\v11_caseA_closed_loop_smoke2_10s\v11_caseA_closed_loop_smoke2_10s_latest_restart.npz `
    --duration 50000 `
    --record-interval 50 `
    --restart-interval 50 `
    --max-dt 0.05 `
