...
def _selected_junction_flows(build: Dict[str, Any]) -> Dict[str, float]:
    names = {
        ...
        "J_HotOutletBranch_1_to_Upper_InletMix_I1",
        "J_HotOutletBranch_1_to_Lower_InletMix_I1",
        "J_Upper_I1_to_A1_I1_to_O1",
        "J_Lower_I1_to_A1_I1_to_O1",
        "J_Upper_A1_I1_to_O1_to_O1",
        "J_Lower_A1_I1_to_O1_to_O1",
        "J_OutletMix_O1_to_Manifold_1",
...
def run_smoke_case(
    *,
    ...
    result: Dict[str, Any] = {
        ...
        "upper_ring_branch_flow_design_kg_s": float(build["upper_ring_branch_flow_design_kg_s"]),
        "lower_ring_branch_flow_design_kg_s": float(build["lower_ring_branch_flow_design_kg_s"]),
        "upper_ring_total_flow_design_kg_s": float(build["upper_ring_total_flow_design_kg_s"]),
        "lower_ring_total_flow_design_kg_s": float(build["lower_ring_total_flow_design_kg_s"]),
        "upper_heatpipe_count": int(build["upper_heatpipe_count"]),
        "lower_heatpipe_count": int(build["lower_heatpipe_count"]),
