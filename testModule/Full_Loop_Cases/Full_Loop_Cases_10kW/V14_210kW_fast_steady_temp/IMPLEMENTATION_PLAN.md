...
- Do not modify files outside `testModule/Full_Loop_Cases/Full_Loop_Cases_10kW/V14_210kW_fast_steady_temp/`.
...
**Files:**
- Create: `testModule/Full_Loop_Cases/Full_Loop_Cases_10kW/V14_210kW_fast_steady_temp/__init__.py`
- Create: `testModule/Full_Loop_Cases/Full_Loop_Cases_10kW/V14_210kW_fast_steady_temp/run_fast_steady.py`
- Create: `testModule/Full_Loop_Cases/Full_Loop_Cases_10kW/V14_210kW_fast_steady_temp/test_fast_steady.py`
- Create: `testModule/Full_Loop_Cases/Full_Loop_Cases_10kW/V14_210kW_fast_steady_temp/runs/.gitkeep`
...
```powershell
& 'E:\Users\HC Zhao\anaconda3\envs\tastin-python\python.exe' -m unittest testModule.Full_Loop_Cases.Full_Loop_Cases_10kW.V14_210kW_fast_steady_temp.test_fast_steady
```
...
```powershell
& 'E:\Users\HC Zhao\anaconda3\envs\tastin-python\python.exe' -m unittest testModule.Full_Loop_Cases.Full_Loop_Cases_10kW.V14_210kW_fast_steady_temp.test_fast_steady
& 'E:\Users\HC Zhao\anaconda3\envs\tastin-python\python.exe' -m py_compile testModule\Full_Loop_Cases\Full_Loop_Cases_10kW\V14_210kW_fast_steady_temp\run_fast_steady.py
```
...
```powershell
git add -- testModule/Full_Loop_Cases/Full_Loop_Cases_10kW/V14_210kW_fast_steady_temp
...
**Files:**
- Runtime outputs only: `testModule/Full_Loop_Cases/Full_Loop_Cases_10kW/V14_210kW_fast_steady_temp/runs/`
