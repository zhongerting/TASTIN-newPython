"""Run the temperature-feedback TEC open-circuit accident."""
...
CASE_NAME = "V14_210kW_TEC_open_circuit_accident_reactive_feedback"
DEFAULT_OUTPUT_DIR = Path(__file__).resolve().parent / "runs" / "final_from_t019865s"


if __name__ == "__main__":
    raise SystemExit(run_cli("reactive_feedback", CASE_NAME, DEFAULT_OUTPUT_DIR))
