...
def load_baseline_debug_config(
    ...
    debug = DebugRunConfig(
        ...
        external_heat_enabled=bool(runtime.external_heat_enabled),
        external_heat_period_s=float(runtime.external_heat_period_s),
        external_heat_time_origin_s=float(runtime.external_heat_time_origin_s),
        restart_in=restart,
    )
    return debug, source
