...
REPRESENTATIVE_NAMES = ("Center", "Ring1", "Ring2", "Ring3_TEC", "Ring3_Open")
DEFAULT_RING_MULTIPLIERS = (1, 6, 12, 15, 3)
DEFAULT_TEC_RING_MULTIPLIERS = (1, 6, 12, 15, 0)
...
class FullLoopCoreConfig:
    ...
    main_tec_target_value: float = 27.2
