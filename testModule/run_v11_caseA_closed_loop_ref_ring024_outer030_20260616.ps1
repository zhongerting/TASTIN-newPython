...
$OutputDir = "testModule\v11_caseA_closed_loop_ref_ring024_outer030_20260616"
$CasePrefix = "v11_caseA_closed_loop_ref_ring024_outer030_20260616"
...
try {
  & $Python testModule\run_v11_caseA_closed_loop.py `
    --restart-in testModule\v11_caseA_closed_loop_ref_overnight_20260616\v11_caseA_closed_loop_ref_overnight_20260616_latest_restart.npz `
    --duration 5000 `
    --record-interval 50 `
    --restart-interval 50 `
    --max-dt 0.05 `
