...
# ============================================================================
print("=" * 72)
print("  TOPAZ-II Coolant Loop - V4.1 (Open-Loop, Q_loop fixed)")
print("=" * 72)
...
while t < T_END:
    ...
    Q_loop_balance = W_TOTAL_DESIGN * Cp * (T_INLET - T_outlet_real)
...
Q_loop_final = W_TOTAL_DESIGN * Cp_final * (T_INLET - T_outlet_real)
...
print()
print(f"  Q_loop  (W·Cp·ΔT):  {Q_loop_final/1000:.2f} kW  (回路真实散热量)")
...
axes[0].set_title(
    f'V4.1 Open-Loop Coolant System (T_in={T_INLET}K, W={W_TOTAL_DESIGN}kg/s)',
    fontweight='bold')
...
out_path = os.path.join(os.path.dirname(os.path.abspath(__file__)),
                        'transient_result_v4_1.png')
plt.savefig(out_path, dpi=120)
print(f"\n  Plot saved: {out_path}")
plt.close()

print("\n" + "=" * 72)
print("  V4.1 Open-Loop simulation completed.")
print("=" * 72)
